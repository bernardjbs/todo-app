...
- Write in **narrative style** — tell the story of what happened this session
- Include **what I learned** and **key takeaways**
- Document decisions with the reasoning behind them
- Note any "aha moments" or surprises
- This is a learning journal, not a changelog

Example tone:
> "Today I learned that Zod validation errors need to be caught at the middleware level, not in individual routes. This was surprising because I expected each route to handle its own errors. The takeaway: centralizing error handling in Hono middleware keeps routes clean and ensures consistent API responses."
